...
$archivePath = Join-Path $projectRoot 'Builds\WorstHotelEver-1.1.0-danger-alpha1-Windows.zip'
...
$copies = @{
    ...
    'docs/reports/qa-danger-alpha1.md' = 'docs/reports/qa-danger-alpha1.md'
    ...
    'TestResults/danger-candidate-results.txt' = 'LOCAL_TEST_RESULTS.txt'
...
$files = @(Get-ChildItem -LiteralPath $buildRoot -Recurse -File | Where-Object {
    ...
    $_.FullName -notmatch '[\\/]docs[\\/]reports[\\/]qa-mvp-rc1[.]md$'
