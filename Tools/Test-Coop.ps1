...
$hostArgs = "-whe-host -whe-smoke -whe-port 17777 -screen-width 1280 -screen-height 800 -screen-fullscreen 0 -logFile `"$hostLog`""
$clientArgs = "-whe-client 127.0.0.1 -whe-smoke -whe-port 17777 -screen-width 1280 -screen-height 800 -screen-fullscreen 0 -logFile `"$clientLog`""
